    ...
    <script>
        ...
        $(function() {
            function add(name) {
                $.ajax({
                    ...
                    success:function(data,textStatus,jqXHR){
                        ...
                        if(data.code == 0)
                        {
                            mesModal("提示","提交"+" 户型 "+data.name+" 成功",function () {
                            ...
                            mesModal("提示","提交"+" 户型 "+data.name+" 失败",function () {
            ...
            $('#add').on('click', function() {
                $('#add-prompt').find(".title").text("增加新的户型").end().modal({
                    relatedTarget: this,
...
//                        alert('你输入的是：' + e.data || '');
    ...
    <script>
            ...
            function update(id,name) {
                $.ajax({
                    ...
                    success:function(data,textStatus,jqXHR){
                        ...
                        if(data.code == 0)
                        {
                            mesModal("提示","修改"+" 户型为"+data.name+" 成功",function () {
            ...
            function handleEditClick() {
                ...
                $('#update-prompt').find(".title").text("修改户型"+name)
