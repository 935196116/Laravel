    ...
    <script>
        ...
        $(function() {
            function add(name) {
                $.ajax({
                    ...
                    success:function(data,textStatus,jqXHR){
                        ...
                        if(data.code == 0)
                        {
                            mesModal("提示","提交"+" 装修 "+data.name+" 成功",function () {
                            ...
                            mesModal("提示","提交"+" 装修 "+data.name+" 失败",function () {
            ...
            $('#add').on('click', function() {
                $('#add-prompt').find(".title").text("增加新的装修").end().modal({
                    relatedTarget: this,
...
//                        alert('你输入的是：' + e.data || '');
    ...
    <script>
            ...
            function handleEditClick() {
                ...
                $('#update-prompt').find(".title").text("修改装修"+name)
...
//                        alert('你输入的是：' + e.data || '');
                        ...
                        update(this.relatedTarget.chooseId,e.data);
